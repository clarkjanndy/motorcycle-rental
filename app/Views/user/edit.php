<div class="container col-lg-6 col-md-10 col-sm-12 p-3 mt-lg-5 mt-md-1 mt-sm-1">
	<div class="card shadow">
		...
		<?php
			$_POST['gender'] = $user['user_gender'];
			$bday = date_format(date_create($user['user_bday']), 'Y-m-d');
		?>
			...
			<form method="POST">
				<div class="row">
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('fname', $user['user_fname']))?>">
					...
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('lname', $user['user_lname']))?>">
				...
				<div class="row">
					<div class="form-group col p-2">
						...
						value="<?php echo(set_value('email', $user['user_email']))?>"> 
				...
				<div class="row">
					<div class="form-group col p-2">
						...
						value="<?php echo(set_value('contact', $user['user_contact']))?>">
				...
				<div class="row">
					<div class="form-group col p-2">
						...
						value="<?php echo(set_value('address', $user['user_address']))?>">
				...
				<div class="row">
					...
					<div class="form-group col p-2">
						...
						value="<?php echo(set_value('bday', $bday))?>">
				...
				<div class="row">
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('password', $session->get('password')))?>">
					...
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('password1', $session->get('password')))?>">
