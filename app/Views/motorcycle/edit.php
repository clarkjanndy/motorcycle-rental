<div class="container col-lg-6 col-md-10 col-sm-12 p-3 mt-lg-5 mt-md-1 mt-sm-1">
	<div class="card shadow">
		<div class="card-header">
			<h4>Edit Motorcyle Form</h4>
		</div>

		<div class="card-body">
			<?php
			$_POST['type'] = $motorcycle['motor_type'];
			$_POST['rate-type'] = $motorcycle['motor_rate_type'];
			?>
			<form method="POST">
				<div class="row">
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('brand', $motorcycle['motor_brand']))?>">
					...
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('model', $motorcycle['motor_model']))?>">
				...
				<div class="row">
					<div class="form-group col-lg-6 p-2">
						...
						value="<?php echo(set_value('year', $motorcycle['motor_year']))?>">
			...
			<div class="row">
				<div class="form-group col-lg-6 p-2">
					...
					value="<?php echo(set_value('displacement', $motorcycle['motor_displacement']))?>">
				...
				<div class="form-group col-lg-6 p-2">
					...
					value="<?php echo(set_value('mileage', $motorcycle['motor_mileage']))?>">
			...
			<div class="form-group col-lg-6 p-2">
				...
				value="<?php echo(set_value('rate', $motorcycle['motor_rate']))?>">
		...
		<div class="row">
			...
			<div class="form-group col p-2">
				...
				value="<?php echo(set_value('location', $motorcycle['motor_location']))?>">
